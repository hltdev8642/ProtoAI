cfg.Fast
 ...
 // --------- --------- --------- 
 //sdcard/Protoeditor/user/init.js 
app.ClearData(  )
app.ClearCookies(  )
 // --------- --------- --------- 
 //-----------------------------------------------------------------------
...
if (!app.LoadBoolean("isLocked", false, "isLocked.txt")) {
  ...
  // --------- --------- --------- 
 //sdcard/Protoeditor/user/ProtoEditor.js 
 // --------- --------- --------- 
...
function OnConfig() {
   if (app.LoadBoolean( "isConfig",null, "isConfig.txt" ))
   {
      ...
      //var urlLeft =  pathData.GetText() + "/web/viewer.html"
//      var urlLeft = "/sdcard/Protoeditor2/web/viewer.html"
//      drawer.buildLeft(urlLeft)
      //drawer.webpdf.LoadUrl(pathData.GetText() + "/web/viewer.html");
  //    drawer.webpdf.LoadUrl(app.LoadText("pathDat", "/sdcard/Protoeditor", "pathDat.txt") + "/" + "web/viewer.html");
  ...
  //     dlgpp.Show()
      ...
      app.CloseDrawer("right");
        ...
        app.RemoveDrawer("left")
  //    var urlLeft = pathData.GetText() + "/web/viewer.html"
//       var urlLeft = drawer.webpdf.LoadUrl(app.LoadText("pathDat", "/sdcard/Protoeditor", "pathDat.txt") + "/" + "web/viewer.html");
          var urlLeft = drawer.webpdf.LoadUrl( "web/viewer.html");
   
      drawer.buildLeft(urlLeft)
      //drawer.webpdf.LoadUrl(pathData.GetText() + "/web/viewer.html");
    // drawer.webpdf.LoadUrl("/sdcard/Protoeditor2/web/viewer.html");
      drawer.buildRight()
//  dlgpp.Hide();
      }
   } //end.OnConfig
...
function onFileChoose(file) {
      ...
      if ((file.indexOf(".jpg") > -1) | (file.indexOf(".png") > -1) | (file.toLowerCase().indexOf(".jpeg") > -1) | (file.indexOf(".svg") > -1) | (file.indexOf(".psd") > -1) | (file.indexOf(".bmp") > -1) | (file.indexOf(".gif") > -1) | (file.indexOf(".ico") > -1) | (file.indexOf(".cr2") > -1) | (file.indexOf(".raw") > -1)) {
         app.SaveText("currentFile", file, "currentFile.txt");
      ...
      if (file.indexOf("pdf") > -1) {
        ...
        // alert(file)
         ...
         app.SaveBoolean("isProtected", true, "isProtected.txt");
       //  app.WriteFile(pathData.GetText() + "/web/viewer.js", scriptA.GetText() + file.replace("content://com.android.externalstorage.documents /document/primary%3A", "" )+ scriptB.GetText());
    ...
    //     //drawer.webpdf.LoadUrl(pathData.GetText() + "/web/viewer.html");
//  if(file.split("file_provider")[1]) {alert("true")}
//alert(
filename = "/sdcard" + file.replace("/sdcard", "/storage/emulated/0").split("/storage/emulated/0")[1]
//)
     //   if (file.split("content://" > -1)){alert("true")}
        
        drawer.webpdf.LoadUrl("web/viewer.html?"+"file=" + filename)//.split("file_provider)
        //app.LoadText("pathDat", "/sdcard/Protoeditor", "pathDat.txt") + "/" + "web/viewer.html");
 ...
 //sdcard/Protoeditor/user/avmedia.js 
 // --------- --------- --------- 
 //------------------------------------------------------------------------
//audioPlayer.js 
//------------------------------------------------------------------------
...
function browser() {
 ...
 // --------- --------- --------- 
 //sdcard/Protoeditor/user/clipBar.js 
 // --------- --------- --------- 
...
function clipBar() {
      this.init = function() {
         ...
         for (var i = 0; i < btns2.length; i++) {
            btn2 = app.CreateButton(btns2[i], .108, null, "FontAwesome");
            btn2.icon = btns2[i];
           btn2.SetTextSize(9);
           btn2.SetPadding( 0,0,0,0 )
            btn2.SetOnTouch(keys_OnTouch);
            layDrawerClipBarB.AddChild(btn2);
...
function spnTxtChange(item) {
    ...
    //sdcard/Protoeditor/user/titleBar.js 
 // --------- --------- --------- 
 //------------------------------------------------------------------------
//titleBar.js 
//------------------------------------------------------------------------
function titleBar() {
 ...
 // --------- --------- --------- 
 //sdcard/Protoeditor/user/codeEditor.js 
 // --------- --------- --------- 
 //------------------------------------------------------------------------
//codeEditor
//------------------------------------------------------------------------
...
function keybd(shown) {
 ...
 // --------- --------- --------- 
 //sdcard/Protoeditor/user/docs.js 
 // --------- --------- --------- 
 function docs() {
      docs.build = function() {
 ...
 // --------- --------- --------- 
 //sdcard/Protoeditor/user/drawers.js 
 // --------- --------- --------- 
 //------------------------------------------------------------------------
//drawers
//------------------------------------------------------------------------
function drawer() {
 ...
 // --------- --------- --------- 
 //sdcard/Protoeditor/user/editorBarA.js 
 // --------- --------- --------- 
 //------------------------------------------------------------------------
//editorBarA
//------------------------------------------------------------------------
function editorBarA() {
 ...
 // --------- --------- --------- 
 //sdcard/Protoeditor/user/editorBarB.js 
 // --------- --------- --------- 
 //------------------------------------------------------------------------
//editorBarB
//------------------------------------------------------------------------
function editorBarB() {
 ...
 // --------- --------- --------- 
 //sdcard/Protoeditor/user/extraKeyBar.js 
 // --------- --------- --------- 
 //------------------------------------------------------------------------
//extraKeyBar.js 
//------------------------------------------------------------------------
function extraKeyBar() {
 ...
 // --------- --------- --------- 
 //sdcard/Protoeditor/user/fileManager.js 
 // --------- --------- --------- 
 //------------------------------------------------------------------------
//fileMgr.js 
//------------------------------------------------------------------------
...
function osr() {
 ...
 // --------- --------- --------- 
 //sdcard/Protoeditor/user/folderLister.js 
 // --------- --------- --------- 
 //------------------------------------------------------------------------
//folderLister.js
//------------------------------------------------------------------------
...
FolderLister.prototype.MakeList = function(options, textSize) {
      ...
      /*all*/
      var list = app.SysExec( ("ls -a1 " + this.path + "; exit"), "su,log" )
      list = list.split("\n").join( '\0')
//      this.list = list
      this.list  = app.CreateList( list, 1, 1, "", '\0' );
      //app.ListFolder(this.path, null, null, this.options));
      ...
      this.list.SetOnTouch(function(path) {
         ...
         */
         var resultcheck = app.SysExec(( "[[ -d '" + fileToOpen + "' ]] && echo 1 || echo 0 ; exit"),"su,log")
         //app.ShowPopup(resultcheck)
         if ( resultcheck == 0)
         {
         // app.ShowPopup( "false" )
           app.CloseDrawer("left");          
...
function picker() {
 ...
 // --------- --------- --------- 
 //sdcard/Protoeditor/user/mdParser.js 
 // --------- --------- --------- 
 //------------------------------------------------------------------------
//mdParser.js 
//------------------------------------------------------------------------
function mdParser(title, bodyTxt) {
 ...
 // --------- --------- --------- 
 //sdcard/Protoeditor/user/multiedit.js 
 // --------- --------- --------- 
 //------------------------------------------------------------------------
//multiEdit.js 
//------------------------------------------------------------------------
...
function _Tabs_OnTouch(ev) {
 ...
 // --------- --------- --------- 
 //sdcard/Protoeditor/user/refilter.js 
 // --------- --------- --------- 
 function refilter() {
      edtTxt.SetOnDoubleTap(function() {
         app.OpenDrawer("right");
...
function filterButtons(array, filter) {
 ...
 // --------- --------- --------- 
 //sdcard/Protoeditor/user/run.js 
 // --------- --------- --------- 
 //------------------------------------------------------------------------
//run.js 
//------------------------------------------------------------------------
function run(syntax) {
   ...
   function StartFile(fname)
{
 //   if (!app.FolderExists("/sdcard/samples")) app.MakeFolder("/sdcard/samples");
 //   app.WriteFile("/sdcard/samples/Sample.js", edt.GetText());
    
    var packageName = "com.smartphoneremote.androidscriptfree";
    var className = "com.smartphoneremote.ioioscript.NewActivity";
    ...
    var extras = [
        {name:"app_file", type:"string", value:fname},
    ];
 ...
 // --------- --------- --------- 
 //sdcard/Protoeditor/user/setTheme.js 
 // --------- --------- --------- 
 //------------------------------------------------------------------------
//setTheme.js 
//------------------------------------------------------------------------
function setTheme() {
 ...
 // --------- --------- --------- 
 //sdcard/Protoeditor/user/tabs.js 
 // --------- --------- --------- 
